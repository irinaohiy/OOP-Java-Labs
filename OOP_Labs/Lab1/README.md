...
| :--- | :--- | :--- | :--- |
| **C2** (Операція O1) | $7 % 2$ | **1** | Операція у знаменнику: **віднімання (-)** |
| **C3** (Константа C) | $7 % 3$ | **1** | Константа $C$ у знаменнику дорівнює **1** |
| **C5** (Операція O2) | $7 % 5$ | **2** | Операція у чисельнику: **остача від ділення (%)** |
| **C7** (Тип індексів) | $7 % 7$ | **0** | Тип ітераторів $i$ та $j$: **byte** |
